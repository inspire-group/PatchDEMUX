...
def main():
    ...
    foldername = f"dump/{val_status}/{todaystring}/trial_{args.trial}_{args.trial_type}_thre_{(int)(args.thre * 100)}percent_{'ViT' if is_ViT else 'resnet'}/gpu_world_id_{args.world_gpu_id}/"
