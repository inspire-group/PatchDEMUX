...
######
        ...
        try:
            ...
            torch.save(save_model.state_dict(), save_model_dir + f"{'ema-' if ema else ''}model-epoch-{epoch}.pth")
        except:
            pass
        ...
        if (average_loss < lowest_val_loss):
            ...
            try:
                torch.save(save_model.state_dict(), args.save_dir + f"{'ema-' if ema else ''}model-best-epoch-{epoch}.pth")
            except:
                pass
